...
/**
\mainpage La biblioteca pantalla es un wrapper de la biblioteca SDL 2.0.
*/
/**
   \file Pantalla.h
...
/**
  \brief Copia una linea vertical de una imagen y la dibuja en pantalla.
  \param sx Coordenada x de la linea de la imagen a dibujar.
  \param x  Coordenada x donde dibujar la linea.
  \param y Coordenada y donde dibujar la linea.
  \param h Longitud de la copia de la linea.
*/
